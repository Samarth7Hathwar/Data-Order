...
incremental_acc_alpha = train_incrementally(
    net, train_data, val_loader, alphabetical_order, criterion, optimizer, scaler, device, step_size=10, augmentation_fn=augmentation_fn
)

# Print final validation accuracy for each step
if local_rank == 0:
    print(f"Validation Accuracies at each step with Random Order: {incremental_acc_alpha}")
